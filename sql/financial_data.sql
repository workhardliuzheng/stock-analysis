CREATE TABLE `financial_data` (
  ...
  `ts_code` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'TS代码',
  `ann_date` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '公告日期',
  `end_date` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '报告期',
  ...
  `update_flag` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '更新标识',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_ts_code_end_date` (`ts_code`,`end_date`) USING BTREE
